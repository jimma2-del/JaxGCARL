...
def resolve(sys: System, state: State, friction_scale: Int ) -> Motion:
  ...
  def impulse(c, link_idx, x_i, xd_i, i_inv, i_mass):
    ...
    impulse_vec = impulse * -c.frame[0] * friction_scale
    ...
    impulse_d = jp.minimum(friction_scale * impulse_d, c.friction[0] * impulse)
