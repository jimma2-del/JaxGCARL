...
def update_actor_and_alpha(config, networks, transitions, training_state, key, is_antag_flag): # mark
    ...
    if (is_antag_flag):
        actor_grad = jax.tree_util.tree_map(lambda g: -g, actor_grad) # MARK
...
def update_critic(config, networks, transitions, training_state, key, is_antag_flag): # mark
    def critic_loss(critic_params, transitions, key):
        ...
        action = transitions.antag_action if is_antag_flag else transitions.protag_action # mark
